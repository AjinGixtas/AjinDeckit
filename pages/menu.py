...
def _start():
    ...
    MENU_DIV = { 'cursor_pos_arr' : ((3, 26), (5, 26), (7, 26)), 'cursor_pos' : 0, 'cursor_options_value' : (scene_manager.MENU_INDEX, scene_manager.PLAY_MENU_INDEX, scene_manager.LEARN_MENU_INDEX, scene_manager.CREDIT_INDEX) }
