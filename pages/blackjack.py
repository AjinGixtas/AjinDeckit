...
def _update(): 
    ...
    if key_state_tracker.get_key_state('enter', key_state_tracker.JUST_PRESSED) and curent_focus_zone_index != SETTING_DIV['index']: 
...
def new_round():
    ...
    BOARD_DIV['player_hands_data'] = [{'ace':0, 'point':0, 'cards':[]}]
