...
def _start():
    ...
    MENU_DIV = { 
        'cursor_options_value' : (scene_manager.BLACKJACK_INDEX, scene_manager.SOLITAIRE_INDEX, scene_manager.FREECELL_INDEX, scene_manager.DUGEON_SOLITAIRE_INDEX),
...
def _update(): 
    ...
    if move_vector != 0:
        MENU_DIV['pad'].addstr(MENU_DIV['cursor_pos_arr'][MENU_DIV['cursor_pos']][0], MENU_DIV['cursor_pos_arr'][MENU_DIV['cursor_pos']][1], ' ')
        MENU_DIV['cursor_pos'] = resources.clip_range(MENU_DIV['cursor_pos'] + move_vector, 0, 3)
        MENU_DIV['pad'].addstr(MENU_DIV['cursor_pos_arr'][MENU_DIV['cursor_pos']][0], MENU_DIV['cursor_pos_arr'][MENU_DIV['cursor_pos']][1], '*')
        MENU_DIV['pad'].refresh(0, 0, MENU_DIV['origin'][0], MENU_DIV['origin'][1], MENU_DIV['end'][0], MENU_DIV['end'][1])
